...
import { readWaveformCacheSafe, WAVEFORM_FALLBACK_ALGORITHM, writeWaveformCacheAtomic, } from "./waveform-cache.js";
import { createFallbackWaveform, generateWaveformWithFfmpeg, } from "./waveform-generator.js";
const inflightWaveformJobs = new Map();
function getOrCreateWaveformJob(getPath, { contentId, filePath }) {
...
export async function getWaveformPeaks(getPath, computeContentId, filePath) {
