...
export function guessAudioMime(filePath) {
...
export async function getAudioSource(filePath) {
    return {
        path: `local-audio:///${filePath.replaceAll("\\", "/")}`,
        mime: guessAudioMime(filePath),
    };
}
export async function computeContentId(filePath) {
...
async function readSampleRange(filePath, start, length) {
